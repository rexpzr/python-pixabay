...
class Pixabay:
    ...
    # Default: "false" 
    #
    # @return Image search metadata in JSON format.
    ...
    ## Video search
    # @brief Search for Pixabay videos using default arguments if no <b>optional</b> arguments supplied.
    #
    # @param q <b>str</b> A URL encoded search term. If omitted, all images are returned. This value may not exceed 100 characters.<br>
    # Example: "cat dog"<br>
    # Default: "yellow flower"
    ...
    # Default: "false" 
    #
    # @return Video search metadata in JSON format.
